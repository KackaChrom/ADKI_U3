...
class Ui_MainWindow(object):
    ...
    def createDTClick(self):
        ...
        if points == []:
            # if there is no point, do nothing
            pass
        else:
    ...
    def createContourLinesClick(self):
        ...
        if points == []:
            ...
            self.Canvas.setMinMaxDz(zmin,zmax,dz)
    ...
    def viewDTClick(self):
        ...
        self.Canvas.drawDT = self.actionDT.isChecked()
    ...
    def viewContourLinesClick(self):
        #Enable/disable drawing
        self.Canvas.drawContourLines = self.actionContour_lines_2.isChecked()
    ...
    def viewSlopeClick(self):
        #Enable/disable drawing
        self.Canvas.drawSlope = self.actionSlope.isChecked()
    ...
    def viewExpositionClick(self):
        #Enable/disable drawing
        self.Canvas.drawAspect = self.actionExposition.isChecked()
